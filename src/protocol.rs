...
///
/// # 🔒 Message handling
/// The calling application is responsible for all message sending and routing
...
///
/// In order to fulfill these requirements, the calling application must
/// maintain a mapping from [`ParticipantIdentifier`]s to the appropriate
/// routing information for that entity.
///
/// The calling application can pass messages for the [`Participant`] as soon as
...
/// caching them in memory. Cached messages are retrieved automatically and
